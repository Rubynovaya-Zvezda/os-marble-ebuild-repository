...
DESCRIPTION="Utility Lib for Hyprland Infrastructure"
...
# a dependency.
RDEPEND="gui-libs/hyprland-protocols dev-libs/pugixml"
...
{
	mkdir build
	cmake --no-warn-unused-cli -DCMAKE_BUILD_TYPE:STRING=Release -DCMAKE_INSTALL_PREFIX:PATH=${DESTDIR}/usr -S . -B build
